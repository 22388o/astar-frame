...
benchmarks! {
    ...
    unregister {
        ...
        prepare_bond_and_stake::<T>(10, &contract_id, SEED)?;
    ...
    withdraw_from_unregistered {
        ...
        DappsStaking::<T>::unregister(RawOrigin::Signed(developer.clone()).into(), contract_id.clone())?;
